...
pubcoder.page.id = pubcoder.page.id || 1907;
 ...
 * 
 */
var obj1911_onLoad_activeActionGroupIndex = -1;
var obj1911_onLoad_runningActionsCount = 0;
var obj1911_onLoad_loopCount = 0;
...
obj1911_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1911_onLoad_activeActionGroupIndex = -1;
		$("#obj1911").trigger("obj1911_onLoad_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 1911) {
				console.warn("de-queueing event obj1911." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1911").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj1911_onLoad_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj1911
(function(){
	window.obj1911_onLoad_runningActionsCount = obj1911_onLoad_runningActionsCount + 1;

	var selector = "#obj1911";
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				...
				if (isLast) {
					window.obj1911_onLoad_runningActionsCount = window.obj1911_onLoad_runningActionsCount - 1;
if (window.obj1911_onLoad_runningActionsCount < 0) {
	window.obj1911_onLoad_runningActionsCount = 0;
} else if (window.obj1911_onLoad_runningActionsCount == 0) {
	obj1911_onLoad_actionGroup1();
}
				}
...
obj1911_onLoad_actionGroup1 = function(){
...
obj2052_onLoad_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 2052) {
				console.warn("de-queueing event obj2052." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj2052").trigger(evt.eventName);
				return;
			}
		}
		return;
...
if (window.obj2052_onLoad_runningActionsCount < 0) {
	window.obj2052_onLoad_runningActionsCount = 0;
} else if (window.obj2052_onLoad_runningActionsCount == 0) {
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1911_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1911_onLoad is still running");
	return;
}
var obj1911_onLoad_runningActionsCount = 0;
var obj1911_onLoad_loopCount = 0;
obj1911_onLoad_actionGroup0();
});
 ...
 */
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj2052_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj2052_onLoad is still running");
	return;
}
var obj2052_onLoad_runningActionsCount = 0;
var obj2052_onLoad_loopCount = 0;
