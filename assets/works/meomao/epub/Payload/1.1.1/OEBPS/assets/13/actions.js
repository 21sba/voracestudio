...
pubcoder.page.id = pubcoder.page.id || 1776;
...
var obj2055_onLoad_activeActionGroupIndex = -1;
var obj2055_onLoad_runningActionsCount = 0;
var obj2055_onLoad_loopCount = 0;
/*
 * 
 * Init SCCounter
 *
...
obj1791_onLoad_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			...
			if (evt.senderObjectId == 1791) {
				console.warn("de-queueing event obj1791." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1791").trigger(evt.eventName);
				return;
			}
		}
		return;
...
if (window.obj1791_onLoad_runningActionsCount < 0) {
	window.obj1791_onLoad_runningActionsCount = 0;
} else if (window.obj1791_onLoad_runningActionsCount == 0) {
...
obj2055_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj2055_onLoad_activeActionGroupIndex = -1;
		$("#obj2055").trigger("obj2055_onLoad_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 2055) {
				console.warn("de-queueing event obj2055." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj2055").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj2055_onLoad_activeActionGroupIndex = 0;
...
//	target: obj2055 
playAudio_2058();
function playAudio_2058() {
	window.obj2055_onLoad_runningActionsCount = obj2055_onLoad_runningActionsCount + 1;
	var myAudio = $("#obj2055")[0];
	...
	if (waitForCompletion) {
		var actionEnded = function() {
		    ...
		    window.obj2055_onLoad_runningActionsCount = window.obj2055_onLoad_runningActionsCount - 1;
if (window.obj2055_onLoad_runningActionsCount < 0) {
	window.obj2055_onLoad_runningActionsCount = 0;
} else if (window.obj2055_onLoad_runningActionsCount == 0) {
	obj2055_onLoad_actionGroup1();
}
		};
...
obj2055_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj2055_onLoad_activeActionGroupIndex = -1;
		$("#obj2055").trigger("obj2055_onLoad_ended");
...
obj2055_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj2055_onLoad_activeActionGroupIndex = -1;
		$("#obj2055").trigger("obj2055_onLoad_ended");
	...
	window.obj2055_onLoad_activeActionGroupIndex = 2;
...
obj2055_onLoad_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj2055_onLoad_activeActionGroupIndex = -1;
		$("#obj2055").trigger("obj2055_onLoad_ended");
	...
	window.obj2055_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1791_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1791_onLoad is still running");
	return;
}
var obj1791_onLoad_runningActionsCount = 0;
var obj1791_onLoad_loopCount = 0;
 ...
 */
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj2055_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj2055_onLoad is still running");
	return;
}
var obj2055_onLoad_runningActionsCount = 0;
var obj2055_onLoad_loopCount = 0;
obj2055_onLoad_actionGroup0();
});
...
$("#obj1777").trigger('SCEventShow');
$("#obj1797").trigger('SCEventShow');
$("#obj2055").trigger('SCEventShow');
	//Buongiorno prof
